      ...
      <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('nama') ? 'is-invalid' : null ?>" id="nama" name="nama" placeholder="Masukan Nama Barang" value="<?= $this->input->post('nama')?>">
            ...
            <div class="form-group">
                ...
                <select name="kategori" id="kategori" class="form-control <?= form_error('kategori') ? 'is-invalid' : null ?>">
                  ...
                  <?php foreach($kategori->result() as $kt):?>
                    <option value="<?= $kt->id_kategori ?>" <?= set_value('kategori') == $kt->id_kategori ? 'selected' : null ?>> <?= $kt->nama?> </option>
                  <?php endforeach;?>
                </select>
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control <?= form_error('description') ? 'is-invalid' : null ?>" placeholder="Masukan Description Barang"><?= $this->input->post('description');?></textarea>
