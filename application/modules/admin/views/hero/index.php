        ...
        <table class="table table-bordered table-responsive-lg table-striped text-center" id="hero">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="<?= base_url('assets/upload/banner/'.$dt->banner)?>" alt="Photo Banner Hero" class="img-fluid img-size-60">
                    </td>
                    <td>
                      <?= date('D, d M Y, H:i:s', strtotime($dt->updated_at)) ?>
                    </td>
                    <td>
                        <a href="<?= base_url('hero/update/'.$dt->id)?>" class="btn btn-primary btn-sm">
