      ...
      <div class="card-body">
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('nama') ? 'is-invalid' : null ?>" id="nama" name="nama" placeholder="Masukan Nama Kategori Barang" value="<?= $this->input->post('nama')?>">
                <span class="text-red"><?= form_error('nama')?></span>
            </div>
            <div class="form-group">
                <label for="description">Description Kategori Barang:</label>
                <textarea name="description" id="description" class="form-control <?= form_error('description') ? 'is-invalid' : null ?>" placeholder="Masukan Description Kategori Barang"><?= $this->input->post('description');?></textarea>
