      ...
      <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('title') ? 'is-invalid' : null ?>" id="title" name="title" placeholder="Masukan Title Superiority" value="<?= $this->input->post('title')?>">
