...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <a href="<?= base_url('superiority/add')?>" class="btn btn-success btn-sm">
        ...
        <table class="table table-bordered table-responsive-lg table-striped text-center" id="hero">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('superiority/update/'.$dt->id)?>" class="btn btn-primary btn-sm">
                            <i class="fa fa-pencil-alt"></i>
                        </a>  |
                        <form action="<?= base_url('superiority/del')?>" method="post" class="d-inline">
