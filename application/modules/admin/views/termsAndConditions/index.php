...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <a href="<?= base_url('termsAndConditions/add')?>" class="btn btn-success btn-sm">
        ...
        <table class="table table-bordered table-responsive-lg table-striped text-center" id="hero">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Title Terms And Conditions</th>
            ...
            <tbody>
                ...
                <tr>
                    <td><?= $no++?></td>
                    <td><?= substr($dt->title, 0, 50)?></td>
                    <td><?= substr($dt->description, 0, 50)?></td>
                    <td>
                      <?= date('D, d M Y, H:i:s', strtotime($dt->created_at)) ?>
                    </td>
                    <td>
                        <a href="<?= base_url('termsAndConditions/update/'.$dt->id)?>" class="btn btn-primary btn-sm">
                            <i class="fa fa-pencil-alt"></i>
                        </a>  |
                        <form action="<?= base_url('termsAndConditions/del')?>" method="post" class="d-inline">
