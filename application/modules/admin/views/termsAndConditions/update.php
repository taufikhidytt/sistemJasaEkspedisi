      ...
      <div class="card-body">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('title') ? 'is-invalid' : null ?>" id="title" name="title" placeholder="Masukan Title Terms And Conditions" value="<?= $this->input->post('title') ?? $data->title ?>">
                <span class="text-red"><?= form_error('title')?></span>
            </div>
            <div class="form-group">
                <label for="description">Description Terms And Conditions:</label>
                <textarea name="description" id="description" class="form-control <?= form_error('description') ? 'is-invalid' : null ?>" placeholder="Masukan Description Terms And Conditions"><?= $this->input->post('description') ?? $data->description ;?></textarea>
